...
<html class="ie6">
  ...
  .slider.round:before {
    border-radius: 50%;
               ...
               <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/16.0.2/css/intlTelInput.css" integrity="sha256-rTKxJIIHupH7lFo30458ner8uoSSRYciA0gttCkw1JE=" crossorigin="anonymous" />
               {{/show_phone_number_field}}
            </head>
                        ...
                        <div id="customer-contact-container">
                            ...
                            {{^only_sms_enabled}}
                              <div class="form-group">
                                <div class="col-xs-12 btn-group btn-group-justified">
                                  {{#show_sms_first}}
                                    <div class="btn-group"> <button type="button" class="btn btn-success">{{ sms_tab_text }}</button> </div>
                                    <div class="btn-group"> <button type="button" class="btn btn-default">{{ email_tab_text }}</button> </div>
                                  {{/show_sms_first}}
                                  {{^show_sms_first}}
                                    <div class="btn-group"> <button type="button" class="btn btn-success">{{ email_tab_text }}</button> </div>
                                    <div class="btn-group"> <button type="button" class="btn btn-default">{{ sms_tab_text }}</button> </div>
                                  {{/show_sms_first}}
                                </div>
                              </div>
                            {{/only_sms_enabled}}
                          ...
                          {{^only_sms_enabled}}
                            <div id="email-address" class="form-group {{#show_sms_first}}hidden{{/show_sms_first}}">
                              <div class="col-xs-12"> <input type="email" placeholder="{{email_address_label}}" class="form-control input-lg" value="{{customer.email}}"> </div>
                            </div>
                          {{/only_sms_enabled}}
          ...
          return e.prototype.variantIsUnavailable = function (e) {
            ...
            e.prototype.create = function (email, e, productId, stockNotificationRequestDetails) {
              ...
              if (this.product !== undefined) {
                ...
                variant_title = this.product.variants.find(variant => {
      ...
      function () {
        ...
        SI.Form = function () {
              ...
              if (this.checked) {
                ...
                if (window.pushowl) {
                  ...
                  registerForEvent.then(function (fulfilled) {
                    ...
                    console.log(mainThis.pushSubscriptionToken);
          ...
          return n.prototype.ACTIVE_CLASS_NAME = "si-popover-active",
            r = (i = "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input") + "/16.0.2/js/intlTelInput.min.js",
        ...
        SI.Popover = function (n) {
          ...
          return e(i, n),
            ...
            i.prototype.onError = function (t) {
              ...
              null != this.form)
                return this.form.showMessage(n.join("\n"))
            }
            ,
        ...
        SI.Analytics = function () {
          ...
          t.prototype.init = function () {
            ...
            if (window.location.pathname.match(/\/checkouts/)) {
              console.log('bis checkout check.');
          ...
          t.prototype.identify = function () {
            if (null !== window.location.search.match(this.key)) {
              console.log('bis cookie read successfully.');
          ...
          t.prototype.trackCheckout = function () {
            ...
            if (null != (t = this.getCookie(this.key))) {
              console.log('bis cookie about to be used for checkout.');
              ...
              console.log('bis cookie was null.');
            }
          };
    ...
    SI.Config = {
      ...
      "partials": {},
        ...
        SI.Config.shop = 'brewdog.myshopify.com';
  ...
  @keyframes fade-in-anim-KT {
    ...
    var link = $('<a>', {
      ...
      href: '#',
      id: 'SI_trigger',
      css: { display: 'none', width: '100%', marginTop: '0.667em' }
    });

    $('form[action="/cart/add"] .product-selectors').eq(0).append(link);
    var countdownTimer = $('<div class="countdown-KT-full-width hide-KT"id="countdownultimate-KT"><div class="countdown-KT"><div class="message-KT">Product Becoming Available ⏱️ in</div><br style="height: 0px;"><div class="countdown-section-KT day"><div class="digit-KT days0"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="digit-KT days1"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="title-KT">DAYS</div></div><div class="separator-KT sday">:</div><div class="countdown-section-KT hour"><div class="digit-KT hrs0"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="digit-KT hrs1"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="title-KT">HRS</div></div><div class="separator-KT shour">:</div><div class="countdown-section-KT minute"><div class="digit-KT mins0"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="digit-KT mins1"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="title-KT">MINS</div></div><div class="separator-KT sminute">:</div><div class="countdown-section-KT second"><div class="digit-KT secs0"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="digit-KT secs1"><div class="card-KT"><div class="card-text-KT"></div></div><div class="card-back-KT"><div class="card-back-text-KT"></div></div><div class="card-bottom-KT"><div class="card-bottom-text-KT"></div></div><div class="card-bottom-back-KT"><div class="card-bottom-back-text-KT"></div></div></div><div class="title-KT">SECS</div></div><div style="text-align: right;display: block !important;width: 100% !important; max-width: 100% !important; height: 100% !important; max-height: 100% !important;"></div></div></div>');
        if(SI.Config.button.countdown_timer_enabled && KT_TOTAL >= 0) {
            $('form[action="/cart/add"] .product-selectors').eq(0).append(countdownTimer);
        }
